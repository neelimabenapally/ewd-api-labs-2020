...
describe('Users API test', function () {
  ...
  // Register user without Authorization Token from Auth0
  it('should prevent user registering without valid token', (done) => {
    supertest(app)
      .post('/api/users')
  ...
  it('should prevent user registering without any token', (done) => {
    supertest(app)
      .post('/api/users')
      .set('Content-Type', 'application/json')
      .send(newUser)
